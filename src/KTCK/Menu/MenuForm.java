...
//Dang xuat
    ...
    String codetran, usercodetran, nametran, servicetran;
    String staffName;
    public void tranLoad(){
        try {
            ...
            while (rst.next()) {
                ...
                staffName=rst.getString(3);
                codetran = rst.getString(1);
                usercodetran =rst.getString(2);
                nametran = rst.getString(3);
                servicetran =rst.getString(4);
...
//History
    Vector vtithis = new Vector();
    Vector vdatahis = new Vector();
    public void updatehistory(){
        try {
            rst = statement.executeQuery("Select * from tran_history where usercode =\""+usercodetran+"\"");
            vtithis.clear();
            vdatahis.clear();
            ResultSetMetaData resultSetMetaData = rst.getMetaData();
            int num_col = resultSetMetaData.getColumnCount();
            for (int i = 1; i <= num_col; i++) {
                vtithis.add(resultSetMetaData.getColumnLabel(i));
            }
...
//User
    private void adduser(){
        try {
            ...
            pst.execute();
            userload();
            label65.setText("Done");
        }catch (Exception e){
            label65.setText("Error. Check Again");
        }
    }
...
//Chart
    ...
    public void showLineChart(){
        ...
        JFreeChart piechart = ChartFactory.createPieChart("STATISTICAL",dataset,false,true,false);
...
//Transaction
    public void updatetran(){
        try {
            PreparedStatement pst = connection.prepareStatement("INSERT INTO  tran_history values (?,?,?,?,?,?)");
            pst.setString(1,codetran);
            pst.setString(2,usercodetran);
            pst.setString(3,nametran);
            pst.setString(4,servicetran);
            pst.setString(5,"2022-02-16");
...
//Services
    ...
    private void usermanagerbt(ActionEvent e) {
        tabbedPane1.setSelectedIndex(4);
    }

    private void profilebt(ActionEvent e) {
        tabbedPane1.setSelectedIndex(7);
    }
    ...
    private void btnConnectClient(ActionEvent e) {

        try{
            mngSocket = new Socket("localhost",12340);
            if (mngSocket != null) {
    ...
    public void button14(ActionEvent e) {
        tabbedPane1.setSelectedIndex(0);
    }
...
//Change Avatar
    private void ChangeAvatarbt(ActionEvent e) {
        ...
        if(jFileChooser.showOpenDialog(null)==jFileChooser.APPROVE_OPTION){
            ...
            imagelb.setText(fileSend[0].getName());
            ImageAvaLB.setIcon(new ImageIcon(getClass().getResource(fileSend[0].getAbsolutePath())));
        }
    }

    private void chatbtn(ActionEvent e) {
        // TODO add your code here
    }
    ...
    private void initComponents() {
        ...
        label68 = new JLabel();
        label69 = new JLabel();
        ServerChat = new JPanel();
        panel21 = new JPanel();
        panel20 = new JPanel();
        btnConnectClient = new JButton();
        button8 = new JButton();
        panel29 = new JPanel();
        ImageAvaLB = new JButton();
        button9 = new JButton();
        imagelb = new JLabel();
        ManagerClient = new JPanel();
        panel30 = new JPanel();
        panel31 = new JPanel();
        ...
        //======== panel1 ========
        {
            ...
            .BOLD,12), Color.red),panel1. getBorder()));panel1. addPropertyChangeListener(
            ...
            //======== panel25 ========
            {
                ...
                //---- profilebt ----
                profilebt.setIcon(new ImageIcon(getClass().getResource("/MN2/img/R (1) (1).png")));
                profilebt.setContentAreaFilled(false);
                profilebt.setBorderPainted(false);
                profilebt.setText("PROFILE");
                profilebt.setForeground(Color.black);
                profilebt.setFont(profilebt.getFont().deriveFont(profilebt.getFont().getSize() + 3f));
                profilebt.addActionListener(e -> profilebt(e));
                panel25.add(profilebt);
                profilebt.setBounds(0, 0, 175, 50);
            ...
            //---- usermanagerbt ----
            usermanagerbt.setText("UserManager");
            usermanagerbt.setBackground(new Color(160, 64, 149));
            usermanagerbt.setForeground(new Color(238, 238, 238));
            usermanagerbt.setFont(new Font("Arial Black", Font.PLAIN, 16));
            usermanagerbt.setContentAreaFilled(false);
            usermanagerbt.setIcon(new ImageIcon(getClass().getResource("/MN2/img/user.png")));
            usermanagerbt.setBorderPainted(false);
            usermanagerbt.setHorizontalAlignment(SwingConstants.LEFT);
            usermanagerbt.addActionListener(e -> {
			homebt(e);
			homebt2(e);
			homebt4(e);
			usermanagerbt(e);
		});
            panel1.add(usermanagerbt);
            usermanagerbt.setBounds(0, 365, 175, 45);
        ...
        chatbtn.setIcon(new ImageIcon(getClass().getResource("/KTCK/img/mess.png")));
        chatbtn.addActionListener(e -> chatbtn(e));
        contentPane.add(chatbtn);
        chatbtn.setBounds(1195, 0, 95, 50);
        ...
        //======== tabbedPane1 ========
        {
            ...
            //======== panel4 ========
            {
                ...
                //======== panel5 ========
                {
                    ...
                    //======== panel8 ========
                    {
                        ...
                        label6.setFont(new Font("Roboto Thin", Font.PLAIN, 34));
                        panel8.add(label6);
                        label6.setBounds(30, 5, 260, 70);

                        //---- label7 ----
                        label7.setText("80MBPS");
                        label7.setFont(new Font("Roboto Thin", Font.PLAIN, 35));
                        label7.setForeground(Color.black);
                        panel8.add(label7);
                        label7.setBounds(85, 90, 205, 47);
                ...
                //======== panel6 ========
                {
                    ...
                    //======== panel10 ========
                    {
                        ...
                        label13.setFont(new Font("Roboto Thin", Font.PLAIN, 34));
                        panel10.add(label13);
                        label13.setBounds(20, 5, 260, 70);

                        //---- label14 ----
                        label14.setText("150MBPS");
                        label14.setFont(new Font("Roboto Thin", Font.PLAIN, 35));
                        label14.setForeground(Color.black);
                        panel10.add(label14);
                        label14.setBounds(75, 80, 185, 47);
            ...
            //======== payment ========
            {
                ...
                payment.add(linebar);
                linebar.setBounds(30, 310, 1140, 310);
                ...
                //======== panel28 ========
                {
                    ...
                    label72.setFont(new Font("SimSun-ExtB", Font.PLAIN, 33));
                    label72.setHorizontalAlignment(SwingConstants.CENTER);
                    panel28.add(label72);
                    label72.setBounds(250, 120, 120, 30);
            ...
            //======== usermanager ========
            {
                ...
                add.setFont(add.getFont().deriveFont(add.getFont().getSize() + 2f));
                add.setContentAreaFilled(false);
                add.addActionListener(e -> addbt(e));
                usermanager.add(add);
                add.setBounds(225, 215, 155, 50);

                //---- delete ----
                delete.setText("DELETE");
                delete.setFont(delete.getFont().deriveFont(delete.getFont().getSize() + 2f));
                delete.setForeground(Color.black);
                delete.setContentAreaFilled(false);
                delete.addActionListener(e -> deletebt(e));
                ...
                delete.setBounds(440, 215, 155, 55);
                ...
                edit.addActionListener(e -> editbt(e));
                usermanager.add(edit);
                edit.setBounds(655, 215, 155, 55);
			...
			CLEARBT(e);
                ...
                label65.setFont(new Font("Segoe UI", Font.PLAIN, 18));
                usermanager.add(label65);
                label65.setBounds(235, 165, 270, label65.getPreferredSize().height);
            ...
            //======== transaction ========
            {
                ...
                //======== panel22 ========
                {
                    panel22.setBackground(new Color(102, 255, 153));
            ...
            //======== contacpn ========
            {
                contacpn.setBackground(Color.white);
                contacpn.setLayout(null);

                //---- label59 ----
                label59.setIcon(new ImageIcon(getClass().getResource("/MN2/img/2037099.png")));
                contacpn.add(label59);
                ...
                contacpn.add(label69);
                label69.setBounds(880, 160, 145, 45);

                {
                    // compute preferred size
                    Dimension preferredSize = new Dimension();
                    for(int i = 0; i < contacpn.getComponentCount(); i++) {
                        Rectangle bounds = contacpn.getComponent(i).getBounds();
                        preferredSize.width = Math.max(bounds.x + bounds.width, preferredSize.width);
                        preferredSize.height = Math.max(bounds.y + bounds.height, preferredSize.height);
                    }
                    Insets insets = contacpn.getInsets();
                    preferredSize.width += insets.right;
                    preferredSize.height += insets.bottom;
                    contacpn.setMinimumSize(preferredSize);
                    contacpn.setPreferredSize(preferredSize);
                }
            }
            tabbedPane1.addTab("text", contacpn);

            //======== ServerChat ========
            {
                ServerChat.setBackground(Color.pink);
                ServerChat.setVisible(false);
                ServerChat.setLayout(null);
                ...
                //======== panel21 ========
                {
                    ...
                    //======== panel20 ========
                    {
                        ...
                        btnConnectClient.addActionListener(e -> btnConnectClient(e));
                        panel20.add(btnConnectClient);
                        btnConnectClient.setBounds(560, 0, 115, 35);
                        ...
                        button8.setFont(new Font("Segoe UI", Font.BOLD, 28));
                        button8.addActionListener(e -> EndConnect(e));
                        panel20.add(button8);
                        button8.setBounds(680, 0, 60, 30);
                    ...
                    panel21.add(panel20, BorderLayout.NORTH);
                }
                ServerChat.add(panel21);
                panel21.setBounds(410, 5, 740, 570);

                {
                    // compute preferred size
                    Dimension preferredSize = new Dimension();
                    for(int i = 0; i < ServerChat.getComponentCount(); i++) {
                        Rectangle bounds = ServerChat.getComponent(i).getBounds();
                        preferredSize.width = Math.max(bounds.x + bounds.width, preferredSize.width);
                        preferredSize.height = Math.max(bounds.y + bounds.height, preferredSize.height);
                    }
                    Insets insets = ServerChat.getInsets();
                    preferredSize.width += insets.right;
                    preferredSize.height += insets.bottom;
                    ServerChat.setMinimumSize(preferredSize);
                    ServerChat.setPreferredSize(preferredSize);
                }
            }
            tabbedPane1.addTab("text", ServerChat);
            ...
            //======== panel29 ========
            {
                ...
                //---- ImageAvaLB ----
                ImageAvaLB.setIcon(new ImageIcon(getClass().getResource("/MN2/img/R (1) (1).png")));
                ImageAvaLB.setContentAreaFilled(false);
                ImageAvaLB.setBorderPainted(false);
                ImageAvaLB.setForeground(Color.black);
                ImageAvaLB.setFont(ImageAvaLB.getFont().deriveFont(ImageAvaLB.getFont().getSize() + 3f));
                ImageAvaLB.addActionListener(e -> profilebt(e));
                panel29.add(ImageAvaLB);
                ImageAvaLB.setBounds(210, 20, 235, 90);

                //---- button9 ----
                button9.setText("Change Avata");
                button9.addActionListener(e -> ChangeAvatarbt(e));
                panel29.add(button9);
                button9.setBounds(270, 115, 95, button9.getPreferredSize().height);

                //---- imagelb ----
                imagelb.setText("imagelb");
                panel29.add(imagelb);
                imagelb.setBounds(385, 115, 45, 30);
            ...
            tabbedPane1.addTab("text", panel29);

            //======== ManagerClient ========
            {
                ManagerClient.setBackground(new Color(153, 255, 255));
                ManagerClient.setVisible(false);
                ManagerClient.setLayout(null);

                //======== panel30 ========
                {
                    panel30.setBackground(new Color(102, 153, 255));
                ...
                ManagerClient.add(panel30);
                panel30.setBounds(70, 10, 1010, 35);
                ...
                //======== panel31 ========
                {
                    ...
                    panel31.add(tabbedPane2);
                    tabbedPane2.setBounds(0, 5, 875, 565);
                ...
                ManagerClient.add(panel31);
                panel31.setBounds(210, 10, 870, 570);

                //======== panel32 ========
                {
                    panel32.setBackground(Color.white);
                    panel32.setLayout(null);
                    panel32.add(scrollPane4);
                    scrollPane4.setBounds(0, 35, 140, 535);
                ...
                ManagerClient.add(panel32);
                panel32.setBounds(70, 10, 140, 570);

                {
                    // compute preferred size
                    Dimension preferredSize = new Dimension();
                    for(int i = 0; i < ManagerClient.getComponentCount(); i++) {
                        Rectangle bounds = ManagerClient.getComponent(i).getBounds();
                        preferredSize.width = Math.max(bounds.x + bounds.width, preferredSize.width);
                        preferredSize.height = Math.max(bounds.y + bounds.height, preferredSize.height);
                    }
                    Insets insets = ManagerClient.getInsets();
                    preferredSize.width += insets.right;
                    preferredSize.height += insets.bottom;
                    ManagerClient.setMinimumSize(preferredSize);
                    ManagerClient.setPreferredSize(preferredSize);
                }
            }
            tabbedPane1.addTab("manager", ManagerClient);
        }
        contentPane.add(tabbedPane1);
        tabbedPane1.setBounds(170, 20, 1185, 652);
    ...
    private JButton ImageAvaLB;
    private JButton button9;
    private JLabel imagelb;
    private JPanel ManagerClient;
